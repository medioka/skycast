...
val Secondary = Color(0xFFBEC6DF)
val SecondaryContainer = Color(0xFF41495D)
val OnSecondary = Color(0xFF283044)

val Tertiary = Color(0xFFFFE5BC)
...
val SurfaceContainerHighest = Color(0xFF2E3634)
val SurfaceVariant = Color(0xFF2E3634)

val OnBackground = Color(0xFFDCE4E1)
val OnSurface = Color(0xFFDCE4E1)
val OnSurfaceVariant = Color(0xFFB9CAC5)

val Outline = Color(0xFF84948F)
val OutlineVariant = Color(0xFF3B4A46)
